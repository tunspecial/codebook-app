            ...
            <nav className="bg-white dark:bg-gray-900">
                <div className="border-b border-slate-200 dark:border-b-0 flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-3">
                    ...
                    <div className="flex items-center relative">
                        <span onClick={() => setDarkMode(!darkMode)} className="cursor-pointer text-xl text-gray-700 dark:text-white mr-5 bi bi-cloud-moon"></span>
                        ...
                        <span onClick={() => setDropDown(!dropdown)} className="bi bi-people-fill cursor-pointer text-2xl text-gray-700 dark:text-white"></span>
