...
export const ProductsList = () => {
    ...
    const { products, initialProdustList } = useFilter()
        ...
        <main>
            <section className="my-5">
                <div className="my-5 flex justify-between">
                    <span className="text-xl font-semibold dark:text-slate-100 mb-5">All eBooks ({products.length})</span>
                    <span>
