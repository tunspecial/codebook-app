...
export const Register = () => {
    ...
    const handleRegister = async (event) => {
        ...
        try {
            ...
            const data = await regiter(authDetails)
            data.accessToken ? navigate("/products") : toast(data)
        }
        catch (error) {
